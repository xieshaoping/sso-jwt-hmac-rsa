...
public class LoginController {
    ...
    public String login(HttpServletResponse httpServletResponse, String username, String password, String redirect, Model model) throws Exception {
        ...
        //生成token
        String token = JwtUtil.generateToken(publicKey, username);
